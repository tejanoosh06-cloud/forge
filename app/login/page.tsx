    ...
    <div className="relative min-h-screen overflow-hidden bg-black text-white flex flex-col">
      ...
      <main className="relative z-10 flex-1 flex flex-col items-center justify-center px-6 text-center">
        <div className="fade-in" style={{ animationDelay: "0s" }}>
          <h1 className="font-black tracking-tight leading-none mb-4" style={{ fontSize: "clamp(64px, 12vw, 128px)", letterSpacing: "-0.04em" }}>
        ...
        <button onClick={signInWithGoogle} disabled={loading} className="fade-in group relative inline-flex items-center justify-center gap-3 px-8 py-4 rounded-full bg-white text-black text-[14px] font-medium hover:bg-white/90 active:scale-95 transition-all disabled:opacity-50" style={{ animationDelay: "0.3s" }}>
      ...
      <style jsx global>{`
        ...
        .orb-purple { width: 650px; height: 650px; background: radial-gradient(circle, rgba(109,40,150,0.7) 0%, rgba(76,29,149,0.5) 40%, transparent 70%); top: 10%; left: 15%; animation: floatPurple 26s ease-in-out infinite; }
        .orb-coral  { width: 750px; height: 750px; background: radial-gradient(circle, rgba(239,68,68,0.7) 0%, rgba(220,38,38,0.5) 40%, transparent 70%); bottom: -250px; right: -200px; animation: floatCoral 22s ease-in-out infinite; }
        .orb-pink   { width: 500px; height: 500px; background: radial-gradient(circle, rgba(236,72,153,0.5) 0%, rgba(219,39,119,0.3) 40%, transparent 70%); top: 20%; right: 5%; animation: floatPink 28s ease-in-out infinite; }
