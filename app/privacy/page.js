      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className={`space-y-6 text-[15px] leading-relaxed ${isDark ? "text-neutral-300" : "text-neutral-700"}`}>
          ...
          <section>
            ...
            <p>Forge is an AI co-founder tool for Indian founders, accessible at forge-omega-roan.vercel.app. This privacy policy explains how we collect, use, and protect your information.</p>
          </section>
          ...
          <section>
            ...
            <p className="mt-3">When you chat with Forge, we store your messages and Forge's responses. This is what allows Forge to remember your conversations across sessions and devices.</p>
          ...
          <section>
            ...
            <ul className="list-disc pl-6 mt-2 space-y-1">
              <li>Provide Forge's chat service to you</li>
              <li>Remember your profile and past conversations</li>
              <li>Personalize Forge's responses based on your founder context</li>
          ...
          <section>
            ...
            <p>Forge uses these services to operate:</p>
            <ul className="list-disc pl-6 mt-2 space-y-1">
              ...
              <li><strong>Sarvam AI</strong> — Indian AI provider that processes your messages to generate Forge's responses</li>
              <li><strong>Vercel</strong> — hosts the Forge app</li>
            </ul>
          ...
          <section>
            ...
            <p>Forge is designed for users 17 and above. We do not knowingly collect data from children under 18 without verifiable parental consent, as required by the DPDP Act.</p>
          </section>
          ...
          <section>
            ...
            <p>For any questions, concerns, or requests related to your data, contact the Forge team at:</p>
