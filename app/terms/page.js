    ...
    <div className={`min-h-screen py-12 px-6 ${isDark ? "bg-black text-neutral-100" : "bg-[#FAFAF7] text-neutral-900"}`}>
      <div className="max-w-3xl mx-auto">
        ...
        <div className={`space-y-6 text-[15px] leading-relaxed ${isDark ? "text-neutral-300" : "text-neutral-700"}`}>
          ...
          <section>
            <h2 className={`text-xl font-semibold mb-2 ${isDark ? "text-neutral-100" : "text-neutral-900"}`}>1. What Forge Is</h2>
            <p>Forge is an AI-powered tool that gives founders advice, frameworks, and information related to building startups in India. By using Forge, you agree to these terms.</p>
          </section>

          <section>
            <h2 className={`text-xl font-semibold mb-2 ${isDark ? "text-neutral-100" : "text-neutral-900"}`}>2. Not Professional Advice</h2>
            <p>Forge provides general business guidance. It is NOT a substitute for professional advice from a:</p>
            ...
            <p className="mt-3">Any legal, financial, tax, medical, or regulatory information shared by Forge is for educational purposes only. Always verify important decisions with a qualified professional before acting on them.</p>
          </section>

          <section>
            <h2 className={`text-xl font-semibold mb-2 ${isDark ? "text-neutral-100" : "text-neutral-900"}`}>3. AI Can Make Mistakes</h2>
            <p>Forge uses AI to generate responses. AI models can produce incorrect, outdated, or misleading information. We display a "Forge can make mistakes" notice in the app for this reason.</p>
            <p className="mt-3">You are responsible for verifying any factual claims, legal information, market data, or financial figures before acting on them. Do not rely on Forge alone for high-stakes decisions.</p>
          </section>

          <section>
            <h2 className={`text-xl font-semibold mb-2 ${isDark ? "text-neutral-100" : "text-neutral-900"}`}>4. Acceptable Use</h2>
            <p>You agree NOT to use Forge to:</p>
            <ul className="list-disc pl-6 mt-2 space-y-1">
              ...
              <li>Attempt to extract, reverse-engineer, or replicate Forge's underlying systems</li>
              <li>Use Forge for spam, scams, or fraud</li>
          ...
          <section>
            ...
            <p>You own the content you upload to Forge (PDFs, profile details, chat messages). By using Forge, you grant us a limited license to process this content for the sole purpose of providing the service to you.</p>
          ...
          <section>
            ...
            <p>If you opt in to the Founders Directory, other signed-in Forge users can see your profile information (name, company, sector, stage, city, what you're building). You can opt out anytime.</p>
          ...
          <section>
            ...
            <p>Forge is provided "as is" without guarantees of uptime, accuracy, or availability. We may modify, suspend, or discontinue features at any time. We are not liable for any losses arising from service interruptions.</p>
          </section>

          <section>
            <h2 className={`text-xl font-semibold mb-2 ${isDark ? "text-neutral-100" : "text-neutral-900"}`}>8. Limitation of Liability</h2>
            <p>To the maximum extent permitted by Indian law, Forge and its operators are not liable for any indirect, incidental, or consequential damages arising from your use of the service. This includes but is not limited to financial losses, business losses, or decisions made based on Forge's responses.</p>
            <p className="mt-3">Our total liability for any claim shall not exceed ₹1,000 or the amount you paid Forge in the past 12 months, whichever is higher.</p>
          </section>
          ...
          <section>
            ...
            <p>We may update these terms occasionally. Continued use of Forge after changes means you accept the updated terms. Material changes will be notified via email or in-app notice.</p>
          </section>
        ...
        <div className={`mt-16 pt-6 border-t text-[12px] ${isDark ? "border-white/10 text-neutral-600" : "border-black/10 text-neutral-400"}`}>
          ...
          <a href="/" className={`transition-colors ${isDark ? "hover:text-neutral-300" : "hover:text-neutral-700"}`}>Back to Forge</a>
        </div>
      </div>
    </div>
  );
